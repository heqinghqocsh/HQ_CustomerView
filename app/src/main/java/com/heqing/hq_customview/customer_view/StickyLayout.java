...
public class StickyLayout extends LinearLayout{
    ...
    private void initData(){
        int headerId = getResources().getIdentifier("sticky_header"
                ,"id",getContext().getPackageName());
        int contentId = getResources().getIdentifier("sticky_content"
                ,"id",getContext().getPackageName());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                smoothSetHeaderHeight(mHeaderHeight,destHeight,1000);
                break;
            default:
                break;
        }
    ...
    public void setHeaderHeight(int height,boolean modifiOriginalHeaderHeight){
        if (modifiOriginalHeaderHeight){
